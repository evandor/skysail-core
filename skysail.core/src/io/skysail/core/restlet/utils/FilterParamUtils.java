...
//import io.skysail.restlet.queries.impl.FilterVisitor;
//
//public final class FilterParamUtils extends ParamsUtils {
//
//    public static final String FILTER_PARAM_KEY = ScalaSkysailServerResource.FILTER_PARAM_NAME;
//
...
//
//    @Override
//    protected Form handleQueryForm(String format, String value) {
...
//
//    @Override
//    protected Form reduceQueryForm(String format, String value) {
//        Form addFormParameters = facet.addFormParameters(new Form(), getFieldname(), handleFormat(format), value);
//        if (getFilterParameter() != null && !"".equals(getFilterParameter().getValue())) {
